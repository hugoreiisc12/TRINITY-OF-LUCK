...
export default function Results() {
  ...
  return (
    <MainLayout 
      ...
      subtitle="Análise #1247 • Apostas Esportivas"
    >
      <TooltipProvider>
        <div className="space-y-8">
          ...
          <section className="glass-card aurora-border overflow-hidden">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent className="max-w-xs">
                      <p>
                        Baseado em 1.247 eventos históricos similares com 
            ...
            {/* Warning Banner */}
            <div className="flex items-center gap-3 border-t border-border/50 bg-destructive/5 px-8 py-4">
